...
def server_aggregate_TD(global_model,client_models,client_local_information,weights_norm,weights,params,round = 'Second',fair_grad = None):
    """
    This function has aggregation method 'mean'
    """
    rt_obj = {}
...
def client_update_TD(client_model,global_model,train_dataset,protected_index,random_seed = None,global_round = 1,round = 'Second',global_fairness_term= None, params= None,weights = None,epoch = 1):
